...
const InnerLabelXSmall = ({
  ...
  return (
    <System.LabelXSmall {...props} style={styles} dangerouslySetInnerHTML={{ __html: content }} />
  )
}

export const LabelXSmall = withHOC(InnerLabelXSmall)
...
addPropertyControls(LabelXSmall, {
  content: {
    title: "Children",
    type: ControlType.String,
    displayTextArea: true,
    defaultValue: "LabelXSmall",
  },
  color: {
    title: "Color",
    type: ControlType.String,
