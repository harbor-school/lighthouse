...
const InnerHeadingXSmall = ({
  ...
  return (
    <System.HeadingXSmall {...props} style={styles} dangerouslySetInnerHTML={{ __html: content }} />
  )
}

export const HeadingXSmall = withHOC(InnerHeadingXSmall)
...
addPropertyControls(HeadingXSmall, {
  content: {
    title: "Children",
    type: ControlType.String,
    displayTextArea: true,
    defaultValue: "HeadingXSmall",
  },
  color: {
    title: "Color",
    type: ControlType.String,
