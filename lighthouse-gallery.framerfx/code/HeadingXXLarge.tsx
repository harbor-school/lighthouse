...
addPropertyControls(HeadingXXLarge, {
  content: {
    title: "Children",
    type: ControlType.String,
    displayTextArea: true,
    defaultValue: "HeadingXXLarge",
  },
  color: {
    title: "Color",
    type: ControlType.String,
