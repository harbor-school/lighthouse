...
const InnerHeadingMedium = ({
  ...
  return (
    <System.HeadingMedium {...props} style={styles} dangerouslySetInnerHTML={{ __html: content }} />
  )
}

export const HeadingMedium = withHOC(InnerHeadingMedium)
...
addPropertyControls(HeadingMedium, {
  content: {
    title: "Children",
    type: ControlType.String,
    displayTextArea: true,
    defaultValue: "HeadingMedium",
  },
  color: {
    title: "Color",
    type: ControlType.String,
