...
Colors in Lighthouse has three token kinds. Scale / Foundational / Semantic tokens are that. The kinds of tokens are linked rigidly for system balances of strictness and flexibility.
<br/>
